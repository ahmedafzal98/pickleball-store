...
const Footer = () => {
  return (
    <>
      <footer class="bg-gradient-to-tl from-[#b8e01857] to-[#000000b4] bg-no-repeat bg-fixed mt-[7%] overflow-x-hidden">
        <div class="mx-auto w-full max-w-screen-xl">
          <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4 text-white">
            <div className="flex flex-col space-y-2">
              <img
                src={footerLogo}
                className="w-[133px] h-24"
                alt="Footer Logo"
              />
            ...
            <div>
              ...
              <div className="bg-white w-1/4 h-1 rounded-2xl mt-2"></div>
            ...
            <div>
              <span className="text-[#B9E018] font-semibold">Resources</span>
              <div className="bg-white w-1/4 h-1 rounded-2xl mt-2"></div>
              <ul className="list-[circle] list-inside mt-10 space-y-2">
                {resources &&
                  resources.map((item) => {
